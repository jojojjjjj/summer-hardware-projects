...
| 02 | env-monitor | project-02-env-monitor-mid | EnvClock | 2/5 Basic | STM32L433 |
| 03 | 4mode-keyboard | project-03-4mode-keyboard | KeyForge | 4/5 Advanced | ESP32-S3 |
...
| 06 | weather-cube | project-06-weather-cube-easy | WeatherCube | 1/5 Beginner | ESP8266 |
| 07 | bipedal-wheeled-robot | project-07-bipedal-wheeled-robot-high | BipedBot | 4/5 Advanced | ESP32-S3 |
| 08 | electronbot | project-08-electronbot-xhigh | ElectronBot | 5/5 Expert | STM32F405 |
...
The pipeline was used to produce the initial projects; the prompts in `prompts/` are the source of truth for re-running or modifying the workflow. `prompts/05_website_visual_upgrade.md`, `06_website_interactive_upgrade.md`, `07_website_architecture_upgrade.md`, `08_website_media_effects_upgrade.md`, `09_hero_mechanical_figure_fusion.md`, `10_hero_2dvideo_3dconstellation.md`, `12_course_stages_upgrade.md`, `13_mission_blackhole_video_upgrade.md`, `14_mobile_optimization.md`, `15_project_links_upstream_primary.md`, `16_image_loading_optimization.md`, `17_project02_redesign.md`, `18_safari_adaptation.md`, `19_course_review_panel.md`, and `20_land_and_close_residuals.md` form a separate, website-only upgrade series (not part of the course-pack pipeline); **07/08/10/12/13/14/15/16/17/18/19/20 are the active rounds** (07 = architecture/3D/flow, 08 = media/effects, 10 = hero 2D-scrub-video + 3D constellation, 12 = course-stages [scoped], 13 = mission section [scoped], 14 = mobile-only [≥768 FROZEN], 15 = project links [upstream-primary], 16 = image loading [signup-focused], 17 = project-02 redesign, 18 = Safari adaptation, 19 = course-design review panel [experiential bar], 20 = land review fixes + close 3 residuals [push parent's 2 unpushed commits + deploy site; P08 Python mock stub → real flashable firmware + Python control, P03 24-file day-XX coherence re-read, P04 local .v Verilog scaffolding or TinyAWG guide; re-verify P03/P04/P08 experiential bar; submodule workflow]). 09 is lineage (hero figure, superseded).
