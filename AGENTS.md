...
### Step 1：启动 Codex Teams 模式
打开 Codex，粘贴 `prompts/00_MASTER_PROMPT.md` 的全部内容作为第一条指令。
...
*本仓库由 Codex Teams 模式自动生成并持续维护。*
*Generated and maintained by Codex Teams Mode.*
